        ...
        function [txGrid, rv, newDat] = stepImpl(obj, iharq)
            ...
            if obj.newDataAvail(iharq)
                ...
                for icw = 1:obj.pdschConfig.NumCodewords
                    ...
                    obj.txBits{iharq}{icw} = randi([0 1], ...
                        obj.trBlkSizes(icw), 1);
                    ...
                    obj.encDLSCH.setTransportBlock(obj.txBits{iharq}{icw},...
                        icw-1,iharq-1);
                end
            ...
            nrv = length(obj.rvSeq);
            irv = mod(obj.rvInd(iharq), nrv);
            rv = obj.rvSeq(irv+1);
            ...
            pdschSymbols = nrPDSCH(obj.carrierConfig, obj.pdschConfig, ...
                codedTrBlock);
           [pdschAntSymbols,pdschAntIndices] = ...
               hPRGPrecode(size(txGrid),obj.carrierConfig.NStartGrid,pdschSymbols,pdschIndices,obj.Fprecode);
